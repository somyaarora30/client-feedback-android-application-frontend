...
public class mail_reportdatewise extends Activity {
    String event_date1="";
    String event_date2="";
    String mailto="";
    String orgnm="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mailreport_datewise);
       ...
       // Log.d("mailto",mailto);
        ...
        new PostAsync().execute(event_date1,event_date2);
        new PostAsync2().execute(event_date1,event_date2);
        ...
        mail_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("mailto",mailto);
               new PostAsync3().execute(event_date1,event_date2,mailto);
               new PostAsync4().execute(event_date1,event_date2,mailto);


                Toast toast = Toast.makeText(mail_reportdatewise.this, "Mail has been sent sucessfully",
                        Toast.LENGTH_LONG);
                ...
                Intent intent = new Intent(
                        mail_reportdatewise.this,Login.class);
    ...
    class PostAsync extends AsyncTask<String, String, JSONObject>{
        ...
        private static final String LOGIN_URL = "http://10.0.3.2/report_topicnames.php";
            ...
            if (json != null)
            {
                    ...
                    try {
                        ...
                        for(int i=0;i<data.length();i++) {
                            ...
                            TableRow row2 = new TableRow(mail_reportdatewise.this);
                            TextView text21 = new TextView(mail_reportdatewise.this);
                            TextView text22 = new TextView(mail_reportdatewise.this);
    ...
    class PostAsync2 extends AsyncTask<String, String, JSONObject>{
        ...
        private static final String LOGIN_URL = "http://10.0.3.2/report_questionnames.php";
            ...
            if (json != null)
            {
                ...
                try {
                    ...
                    for(int i=0;i<data.length();i++) {
                        ...
                        TableRow row4 = new TableRow(mail_reportdatewise.this);
                        TextView text41 = new TextView(mail_reportdatewise.this);
                        TextView text42 = new TextView(mail_reportdatewise.this);
    ...
    class PostAsync3 extends AsyncTask<String, String, JSONObject>{
        ...
        private static final String LOGIN_URL = "http://10.0.3.2/mail2.php";
    ...
    class PostAsync4 extends AsyncTask<String, String, JSONObject>{
        ...
        private static final String LOGIN_URL = "http://10.0.3.2/mail3.php";
