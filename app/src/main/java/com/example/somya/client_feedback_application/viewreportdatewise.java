...
public class viewreportdatewise extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewreportdatewise);
       ...
       orgname=(EditText)findViewById(R.id.orgname);
        ...
        view_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(viewreportdatewise.this,mail_reportdatewise.class);
